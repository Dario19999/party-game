...
public class CameraManager : MonoBehaviour
{
    ...
    [SerializeField]
    private float _zoomMax = -0.5f, _zoomMin = -10f;
    #endregion
    ...
    void Start()
    {
        ...
        if (_player == null)
        {
            Debug.Log("Falta asignar el personaje al CameraManager.cs");
        }
        if (_playerCamera == null)
        {
            Debug.Log("Falta asignar la cámara al CameraManager.cs");
        }
        if (_focusPoint == null)
        {
            Debug.Log("Falta asignar el punto de foco al CameraManager.cs");
        }
        #endregion
