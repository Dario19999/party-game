...
public class MoverALaIzquierda : MonoBehaviour
{
    ...
    void Start()
    {
        scriptControlJugador = GameObject.Find("Jugador").GetComponent<ControlJugador>(); //Encuentra el objeto llamado jugador y dentro del objeto jugador, obtiene el componente ControlJugador que es el script
    }
    ...
    void Update()
    {
        ...
        {
            transform.Translate(Vector3.left * velocidad * Time.deltaTime); //el piso y el fondo se movera a la izquierda
        }
